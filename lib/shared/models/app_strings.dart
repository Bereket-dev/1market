...
class AppStrings {
  ...
  String get homeViewAll =>
      _t('View All Recent Listings', 'ሁሉንም ዝርዝሮች ይመልከቱ', 'Arag dhammaan xayaysiisyada');
  String get homeTrustTitle =>
      _t('Trusted Community', 'ታመነ ማህበረሰብ', 'Bulshada la믿aha ah');
  String get homeVerifiedStats =>
      _t('98% verified listings in Jigjiga', '98% የተረጋገጡ ዝርዝሮች', '98% xayaysiis xaqiijiyey');
  String get homeSeeStats =>
      _t('See stats', 'ስታቲስቲክስ ይመልከቱ', 'Arag tirooyin');
  String get homeNoNotifications =>
      _t('No new notifications', 'አዲስ ማሳወቂያ የለም', 'Wax ogeysiis cusub ma jiraan');
  ...
  String get savedSelectTwo =>
      _t('Select up to 2 listings', 'እስከ 2 ዝርዝሮች ይምረጡ', 'Dooro ilaa 2 xayaysiis');
  ...
  String get messagesEmpty =>
      _t('No active chats yet', 'ምንም ንቁ ቻት የለም', 'Ma jiraan sheekooyin firfircoon');
